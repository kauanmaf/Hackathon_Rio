...
dg_sub_bacias = pd.read_csv("api/database_csv/sub_bacias.csv")
dg_grid = pd.read_csv("api/database_csv/h3_grid_res8.csv")
...
ra_lam_inea = pd.read_csv("api/database_csv/lamina_agua_inea.csv")
ra_lam_via = pd.read_csv("api/database_csv/nivel_lamina_agua_via.csv")
ra_nivel_reservatorio = pd.read_csv("api/database_csv/nivel_reservatorio.csv")

# # Radares_metereológicos
# cor_tx_precip_guaratiba = pd.read_csv("api/database_csv/taxa_precipitacao_guaratiba.csv")
